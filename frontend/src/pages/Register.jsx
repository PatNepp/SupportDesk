...
function Register() {
    ...
    const onSubmit = (e) => {
        ...
        if(password !== password2) {
            ...
            //dispatching register from authSlice
    ...
    <>
        ...
        <section className="form">
            <form onSubmit={onSubmit}>
                ...
                <div className="form-group">
                    <input type="password" className="form-control" id='password2' value={password2} onChange={onChange} placeholder='Confirm your password' name='password2' required />
                </div>
                <div className="form-group">
